"""
Configuration and constants for Wired Recon application
"""


class Colors:
    """Color scheme for the CRT-style terminal"""
    PRIMARY = "#8941AD"  # Purple
    SECONDARY = "#d2738a"  # Pink
    ACCENT = "#8b00ff"  # Purple accent
    TEXT = "#c0c0c0"  # Silver/gray
    DIM = "#606060"  # Dim gray
    TARGET = "#6495ed"  # Azul Copland (cornflower blue)
    INPUT = "#ff3333"  # Vermelho para input
...
class Dimensions:
    ...
    # Target box in top-right corner (aligned to edge)
